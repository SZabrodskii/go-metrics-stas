...
func (Metric_MType) EnumDescriptor() ([]byte, []int) {
	return file_proto_metrics_metrics_proto_rawDescGZIP(), []int{0, 0}
}
...
const file_proto_metrics_metrics_proto_rawDesc = "" +
	"\n" +
	"\x1bproto/metrics/metrics.proto\x12\ametrics\"\x90\x01\n" +
	"\x06Metric\x12\x0e\n" +
	...
	"\aMetrics\x12N\n" +
	"\rUpdateMetrics\x12\x1d.metrics.UpdateMetricsRequest\x1a\x1e.metrics.UpdateMetricsResponseB?Z=github.com/SZabrodskii/go-metrics-stas/internal/proto/metricsb\x06proto3"
...
var file_proto_metrics_metrics_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
